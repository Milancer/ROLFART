...
export class DashboardComponent implements OnInit{
  ...
  constructor(private serverinfo: ServerinfoService){
    ...
    this.subscription = source.subscribe(val => this.getServerJsonInfo());
  }
      ...
      this.chartHours = new Chart(this.ctx, {
        ...
        data: {
          ...
          datasets: [{
              ...
              pointHoverRadius: 0,
              borderWidth: 3,
              data: [10, 13, 15, 17, 19, 20, 22, 23, 25, 27, 29]
            },
            {
              borderColor: "#f17e5d",
              ...
              pointHoverRadius: 0,
              borderWidth: 3,
              data: [20, 23, 25, 27, 29, 30, 32, 33, 35, 37, 39]
            },
            {
              borderColor: "#fcc468",
              ...
              pointHoverRadius: 0,
              borderWidth: 3,
              data: [30, 33, 35, 37, 39, 40, 42, 43, 45, 47, 49]
            }
          ]
        },
        options: {
